"""
Здесь описание абстрактного репозитория.

Репозиторий реализует хранение объектов, присваивая каждому объекту уникальный
первичный ключ pk (primary key). Объекты, которые могут быть сохранены
...
class AbstractRepository(ABC, Generic[T]):
    ...
    def get_all(self, where: dict[str, Any] | None = None) -> list[T]:
        """
        Получение всех записей по некоторому условию
    ...
    def update(self, obj: T) -> None:
        """ Обновление данных об объекте. Объект должен содержать поле первичного ключа pk. """
